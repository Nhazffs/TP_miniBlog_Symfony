...
namespace Proxies\__CG__\Emds\MiniBlogBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Message extends \Emds\MiniBlogBundle\Entity\Message implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Emds\\MiniBlogBundle\\Entity\\Message' . "\0" . 'id', '' . "\0" . 'Emds\\MiniBlogBundle\\Entity\\Message' . "\0" . 'date', '' . "\0" . 'Emds\\MiniBlogBundle\\Entity\\Message' . "\0" . 'titre', '' . "\0" . 'Emds\\MiniBlogBundle\\Entity\\Message' . "\0" . 'auteur', '' . "\0" . 'Emds\\MiniBlogBundle\\Entity\\Message' . "\0" . 'contenu');
        }
